...
public class MyPageController {
	...
	// 내 정보 페이지 이동
//	@GetMapping("/member/myPage/info") -> 원래대로라면 이렇게 작성
	...
	public String updateInfo(Member inputMember, 
		...
		// inputMember : 입력 받은 memberNickname / memberTel / memberAddress(가공)
		...
		// 2. memberAddress의 값에 따라 inputMember의 adress값 변경
		...
		if(result > 0) { message = "회원 정보가 수정되었습니다.";
		...
		public String memberDelete(
			...
			// ex) session 에서 "loginMember"를 없애야 한다
			// == @SessionAttributes("loginMember")
			// ...
			// staus.complete(); // "loginMember" 무효화
		...
		public String profile() {
			...
			return "/member/myPage-profile"; //WEB-INF/views/member/myPage-profile.jsp
	}
		...
		public String updateProfile(
				@RequestParam("profileImage") MultipartFile profileImage, /* 업로드된 파일*/
